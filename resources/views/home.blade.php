    ...
    <div class="max-w-5xl mx-auto">
      <div class="flex justify-center mb-10">
        <div class="relative group">
          <div class="hidden md:block absolute -inset-4 bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 rounded-full opacity-75 blur-lg group-hover:opacity-100 animate-spin-slow"></div>
          <div class="hidden md:block absolute -inset-6 bg-gradient-to-r from-cyan-600 via-purple-600 to-blue-600 rounded-full opacity-50 blur-xl animate-spin-reverse"></div>
          ...
          <div class="relative w-40 h-40 md:w-48 md:h-48">
            ...
            <div class="absolute bottom-0 right-0 md:bottom-2 md:right-2 flex items-center space-x-1 bg-black/80 backdrop-blur-sm px-2 md:px-3 py-1 rounded-full border border-green-500/50 shadow-[0_0_20px_rgba(34,197,94,0.5)]">
              ...
              <span class="text-xs text-green-400 font-medium hidden md:inline-block">{{ __('pages.available_status') }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="text-center space-y-8">
        <div class="space-y-4">
          ...
          <div class="h-8 md:h-10 relative overflow-hidden max-md:font-sans">
            <div class="md:animate-text-slide">
              ...
              <p class="text-xl md:text-2xl text-gray-300 h-8 md:h-10 hidden md:flex items-center justify-center">{{ __('pages.role_2') }}</p>
              <p class="text-xl md:text-2xl text-gray-300 h-8 md:h-10 hidden md:flex items-center justify-center">{{ __('pages.role_3') }}</p>
              <p class="text-xl md:text-2xl text-gray-300 h-8 md:h-10 hidden md:flex items-center justify-center">{{ __('pages.role_4') }}</p>
            </div>
          </div>
        </div>
        
        <p class="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed md:animate-fade-in md:delay-400 max-md:font-sans">
        ...
        <div class="flex justify-center space-x-6 md:animate-fade-in md:delay-800">
      ...
      <div class="absolute bottom-10 left-1/2 -translate-x-1/2 md:animate-bounce">
        <a href="#about" aria-label="{{ __('pages.scroll_text') ?: 'Scroll down' }}" class="flex flex-col items-center text-gray-400 hover:text-white transition-colors duration-300 group">
          <span class="text-xs uppercase tracking-wider mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hidden md:block">{{ __('pages.scroll_text') }}</span>
    ...
    <div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
      <div class="relative order-2 lg:order-1">
        <div class="relative group perspective-1000">
          ...
          <div class="relative rounded-3xl overflow-hidden transform-gpu transition-all duration-700 md:group-hover:rotate-y-12">
            <div class="absolute inset-0 bg-gradient-to-br from-purple-600/20 via-transparent to-blue-600/20 z-10"></div>
            <x-responsive-image path="img/avatar.webp" alt="About" width="800" height="800" sizes="(max-width: 1024px) 100vw, 50vw" class="w-full h-auto object-cover md:transform md:group-hover:scale-110 transition-transform duration-700" />
          </div>
          <div class="absolute -bottom-8 -right-8 md:-bottom-8 md:-right-8 right-4 bottom-[-1rem] bg-black/80 md:bg-black/60 backdrop-blur-2xl border border-white/10 rounded-2xl p-4 md:p-6 shadow-2xl md:transform md:hover:scale-105 transition-all duration-300">
          ...
          <div class="hidden md:flex absolute -top-4 -right-4 bg-gradient-to-br from-purple-500 to-pink-500 w-20 h-20 rounded-2xl items-center justify-center text-white font-bold text-xl shadow-2xl animate-float">
      ...
      <div class="space-y-8 order-1 lg:order-2">
        ...
        <div class="flex items-center space-x-6 pt-4">
          ...
          <a href="#" class="text-gray-400 hover:text-white transition-colors duration-300 flex items-center space-x-2 group">
            ...
            <i class="fas fa-download md:group-hover:translate-y-1 transition-transform duration-300"></i>
          </a>
        </div>
      </div>
    </div>
...
<section id="stack" class="py-32 bg-gradient-to-b from-black via-gray-900/50 to-black overflow-hidden relative">
  ...
  <div class="container mx-auto px-4 relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
      <div class="group relative md:transform md:hover:-translate-y-2 transition-all duration-500">
        <div class="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded-3xl blur-xl opacity-0 md:group-hover:opacity-100 md:group-hover:shadow-[0_0_25px_rgba(6,182,212,0.3)] transition-all duration-500"></div>
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 md:group-hover:scale-110 transition-transform duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            <i class="fas fa-code text-2xl text-white"></i>
          </div>
          <h3 class="text-2xl font-bold text-white mb-4">{{ __('pages.frontend_title') }}</h3>
          <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-html5 text-orange-400"></i><span>{{ __('pages.tech_html_css') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-js text-yellow-400"></i><span>{{ __('pages.tech_js') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-vuejs text-green-400"></i><span>{{ __('pages.tech_vue') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-wind text-cyan-400"></i><span>{{ __('pages.tech_tailwind') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-bootstrap text-purple-400"></i><span>{{ __('pages.tech_bootstrap') }}</span></li>
          </ul>
        </div>
      </div>
      <div class="group relative md:transform md:hover:-translate-y-2 transition-all duration-500">
        <div class="absolute inset-0 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-3xl blur-xl opacity-0 md:group-hover:opacity-100 md:group-hover:shadow-[0_0_25px_rgba(219,39,119,0.3)] transition-all duration-500"></div>
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 md:group-hover:scale-110 transition-transform duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            <i class="fas fa-server text-2xl text-white"></i>
          </div>
          <h3 class="text-2xl font-bold text-white mb-4">{{ __('pages.backend_title') }}</h3>
          <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-php text-purple-400"></i><span>{{ __('pages.tech_php') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-laravel text-red-400"></i><span>{{ __('pages.tech_laravel') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-node-js text-green-400"></i><span>{{ __('pages.tech_node') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-plug text-blue-400"></i><span>{{ __('pages.tech_rest') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-project-diagram text-pink-400"></i><span>{{ __('pages.tech_graphql') }}</span></li>
          </ul>
        </div>
      </div>
      <div class="group relative md:transform md:hover:-translate-y-2 transition-all duration-500">
        <div class="absolute inset-0 bg-gradient-to-r from-green-600/20 to-emerald-600/20 rounded-3xl blur-xl opacity-0 md:group-hover:opacity-100 md:group-hover:shadow-[0_0_25px_rgba(16,185,129,0.3)] transition-all duration-500"></div>
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mb-6 md:group-hover:scale-110 transition-transform duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            <i class="fas fa-database text-2xl text-white"></i>
          </div>
          <h3 class="text-2xl font-bold text-white mb-4">{{ __('pages.database_title') }}</h3>
          <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-database text-blue-400"></i><span>{{ __('pages.tech_mysql') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-database text-blue-300"></i><span>{{ __('pages.tech_postgresql') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-memory text-red-400"></i><span>{{ __('pages.tech_redis') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-docker text-blue-400"></i><span>{{ __('pages.tech_docker') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-git-alt text-orange-400"></i><span>{{ __('pages.tech_git') }}</span></li>
          </ul>
        </div>
      </div>
      <div class="group relative md:transform md:hover:-translate-y-2 transition-all duration-500">
        <div class="absolute inset-0 bg-gradient-to-r from-yellow-600/20 to-amber-600/20 rounded-3xl blur-xl opacity-0 md:group-hover:opacity-100 md:group-hover:shadow-[0_0_25px_rgba(245,158,11,0.3)] transition-all duration-500"></div>
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <div class="w-16 h-16 bg-gradient-to-br from-yellow-500 to-amber-500 rounded-2xl flex items-center justify-center mb-6 md:group-hover:scale-110 transition-transform duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            <i class="fab fa-python text-2xl text-white"></i>
          </div>
          <h3 class="text-2xl font-bold text-white mb-4">{{ __('pages.python_title') }}</h3>
          <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-python text-yellow-400"></i><span>{{ __('pages.tech_python_web') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-robot text-cyan-400"></i><span>{{ __('pages.tech_rpa') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-chart-bar text-green-400"></i><span>{{ __('pages.tech_data_science') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-microchip text-red-400"></i><span>{{ __('pages.tech_python_api') }}</span></li>
          </ul>
        </div>
      </div>
      <div class="group relative md:transform md:hover:-translate-y-2 transition-all duration-500">
        <div class="absolute inset-0 bg-gradient-to-r from-pink-600/20 to-rose-600/20 rounded-3xl blur-xl opacity-0 md:group-hover:opacity-100 md:group-hover:shadow-[0_0_25px_rgba(244,114,182,0.3)] transition-all duration-500"></div>
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <div class="w-16 h-16 bg-gradient-to-br from-pink-500 to-rose-500 rounded-2xl flex items-center justify-center mb-6 md:group-hover:scale-110 transition-transform duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            <i class="fas fa-project-diagram text-2xl text-white"></i>
          </div>
          <h3 class="text-2xl font-bold text-white mb-4">{{ __('pages.nocode_title') }}</h3>
          <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-cogs text-purple-400"></i><span>{{ __('pages.tech_n8n_make') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-bolt text-yellow-400"></i><span>{{ __('pages.tech_zapier') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-cloud text-blue-400"></i><span>{{ __('pages.tech_octabase') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-link text-green-400"></i><span>{{ __('pages.tech_webhooks') }}</span></li>
          </ul>
        </div>
      </div>
      <div class="group relative md:transform md:hover:-translate-y-2 transition-all duration-500">
        <div class="absolute inset-0 bg-gradient-to-r from-orange-600/20 to-red-600/20 rounded-3xl blur-xl opacity-0 md:group-hover:opacity-100 md:group-hover:shadow-[0_0_25px_rgba(239,68,68,0.3)] transition-all duration-500"></div>
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mb-6 md:group-hover:scale-110 transition-transform duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            <i class="fas fa-search text-2xl text-white"></i>
          </div>
          <h3 class="text-2xl font-bold text-white mb-4">{{ __('pages.seo_title') }}</h3>
          <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-chart-line text-green-400"></i><span>{{ __('pages.tech_seo') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fab fa-google text-blue-400"></i><span>{{ __('pages.tech_search_console') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-tachometer-alt text-purple-400"></i><span>{{ __('pages.tech_pagespeed') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-share-alt text-cyan-400"></i><span>{{ __('pages.tech_schema') }}</span></li>
          </ul>
        </div>
      </div>
      <div class="group relative md:transform md:hover:-translate-y-2 transition-all duration-500">
        <div class="absolute inset-0 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 rounded-3xl blur-xl opacity-0 md:group-hover:opacity-100 md:group-hover:shadow-[0_0_25px_rgba(129,140,248,0.3)] transition-all duration-500"></div>
        <div class="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
          <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center mb-6 md:group-hover:scale-110 transition-transform duration-300 shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
            <i class="fas fa-pen-fancy text-2xl text-white"></i> 
          </div>
          <h3 class="text-2xl font-bold text-white mb-4">{{ __('pages.copywriting_title') }}</h3>
          <ul class="space-y-3 text-sm text-gray-300">
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-bullhorn text-blue-400"></i><span>{{ __('pages.copywriting_brand_voice') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-ad text-green-400"></i><span>{{ __('pages.copywriting_ads') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-file-alt text-yellow-400"></i><span>{{ __('pages.copywriting_content') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-envelope-open-text text-purple-400"></i><span>{{ __('pages.copywriting_email') }}</span></li>
            <li class="flex items-center space-x-2 hover:text-white transition-colors duration-300"><i class="fas fa-user-edit text-pink-400"></i><span>{{ __('pages.copywriting_storytelling') }}</span></li>
          </ul>
        </div>
      </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Desktop Only Effects (Salvam CPU pe mobil)
  if (isDesktop) {
    ...
    function createParticle() {
      ...
      particle.style.cssText = `
        ...
        background: rgba(255, 255, 255, 0.5); pointer-events: none; border-radius: 50%;
